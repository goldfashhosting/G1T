...
<div class="scroll">
	...
	<table id="site-info">
		...
		<tr>
			...
			<td><a target="G1TANA" href="https://goldfash.com/views/?do=Analytics&views=api&view=qu&ss=<?php echo $_SERVER['HTTP_HOST'] ;?>&ref=<?php echo $_SERVER['HTTP_HOST'] ;?>/wp-admin/admin.php?page=G1T"><?php echo $thisView->Source; ?></a></td>
		</tr>
